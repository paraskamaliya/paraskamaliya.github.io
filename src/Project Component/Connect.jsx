...
const Connect = () => {
    ...
    return <Stack display={"flex"} flexDirection={["column", "column", "row", "row", "row"]} gap={"20px"} padding={"20px"} alignContent={"center"} alignItems={"center"} className="project-card">
        ...
        <Box w={["80%", "80%", "50%", "50%", "50%"]}>
            ...
            <Text mt={"15px"} mb={"15px"} className="project-description" >Step into the future of efficient management with 'Connect.' This dynamic website unites <span style={{ color: "#00a2ff" }}>students, managers, and administrators</span>, empowering them with tailored interfaces for seamless collaboration. Immerse yourself in a sleek, user-friendly environment with the added charm of a customizable <span style={{ color: "#00a2ff" }}>dark mode</span>. Engage in vibrant <span style={{ color: "#00a2ff" }}>discussions</span> and stay informed with the <span style={{ color: "#00a2ff" }}>latest announcements</span>. 'Connect' - where functionality meets elegance, making management an absolute pleasure.</Text>
