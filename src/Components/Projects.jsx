...
const Projects = () => {
    ...
    return <Box w={"100%"} backgroundColor={theme === "dark" ? "black" : "white"} color={theme === "dark" ? "white" : "black"} id="projects" borderBottom={"1px"} borderBottomColor={theme == "dark" ? "white" : "black"} pb={"1rem"}>
        ...
        <Box border={"1px"} w={"90%"} m={"auto"} borderRadius={"10"} p={"0.5rem"}>
