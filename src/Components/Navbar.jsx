...
const Navbar = () => {
    ...
    return <Box w={"100%"} backgroundColor={theme === "dark" ? "#262626" : "#eaeaea"} color={theme === "dark" ? "white" : "black"} id="nav-menu" position={"sticky"} top={"0"} zIndex={"100"}>
        ...
        >
            <DrawerOverlay />
            <DrawerContent bg={theme === "dark" ? "#262626" : "#eaeaea"}>
