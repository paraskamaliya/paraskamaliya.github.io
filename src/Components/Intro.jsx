        ...
        <Box m={"auto"} w={"90%"} >
            <Stack display={"flex"} m={"auto"} justifyContent={"center"} flexDirection={["column", "column", "row", "row", "row"]} alignItems={"center"} w={"100%"} borderBottom={"1px"} borderBottomColor={theme == "dark" ? "white" : "black"}>
                <Box textAlign={"left"} padding={"1rem"} fontSize={"2rem"} m={"auto"} w={["100%", "85%", "70%", "50%", "50%"]}>
                    ...
                    <a href={"../../public/ParasKamaliya_Resume.pdf"} download id="resume-link-2" target="_blank" style={{ backgroundColor: theme === "dark" ? "white" : "black", border: "1px solid black", padding: "1px 15px 1px 15px", borderRadius: "10px", color: theme === "dark" ? "black" : "white", fontSize: "25px" }}>Resume</a>
                </Box>
